...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* PROC :init: */
	case 3: // STATE 1 - trash_bin.pml:299 - [proc = 0] (0:0:1 - 1)
		IfNotBlocked
		reached[5][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 2 - trash_bin.pml:301 - [((proc<1))] (14:0:11 - 1)
		IfNotBlocked
		reached[5][2] = 1;
		...
		reached[5][13] = 1;
		(trpt+1)->bup.ovals[10] = ((int)max_capacity);
		max_capacity = 2;
#ifdef VAR_RANGES
		logval("max_capacity", ((int)max_capacity));
#endif
		;
		_m = 3; goto P999; /* 11 */
	case 5: // STATE 14 - trash_bin.pml:314 - [(run bin(proc))] (0:0:0 - 1)
		IfNotBlocked
		reached[5][14] = 1;
		if (!(addproc(II, 1, 0, ((int)((P5 *)_this)->proc), 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 6: // STATE 15 - trash_bin.pml:315 - [proc = (proc+1)] (0:0:1 - 1)
		IfNotBlocked
		reached[5][15] = 1;
		(trpt+1)->bup.oval = ((int)((P5 *)_this)->proc);
		...
		;
		_m = 3; goto P999; /* 0 */
	case 7: // STATE 16 - trash_bin.pml:316 - [((proc==1))] (24:0:4 - 1)
		IfNotBlocked
		reached[5][16] = 1;
		if (!((((int)((P5 *)_this)->proc)==1)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 8: // STATE 21 - trash_bin.pml:321 - [proc = 0] (0:24:3 - 3)
		IfNotBlocked
		reached[5][21] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 9: // STATE 24 - trash_bin.pml:324 - [(run user(proc,trash_size))] (0:0:2 - 1)
		IfNotBlocked
		reached[5][24] = 1;
		...
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 25 - trash_bin.pml:327 - [(run server())] (0:0:0 - 1)
		IfNotBlocked
		reached[5][25] = 1;
		if (!(addproc(II, 1, 1, 0, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 26 - trash_bin.pml:329 - [(run truck())] (0:0:0 - 1)
		IfNotBlocked
		reached[5][26] = 1;
		if (!(addproc(II, 1, 2, 0, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 27 - trash_bin.pml:332 - [(run main_control())] (0:0:0 - 1)
		IfNotBlocked
		reached[5][27] = 1;
		if (!(addproc(II, 1, 4, 0, 0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 29 - trash_bin.pml:334 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[5][29] = 1;
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC main_control */
	case 14: // STATE 1 - trash_bin.pml:286 - [scan_card_user?user_id] (0:0:2 - 1)
		reached[4][1] = 1;
		...
		if (!readtrail)
			...
			((P4 *)_this)->user_id = 0;
		_m = 4; goto P999; /* 0 */
	case 15: // STATE 6 - trash_bin.pml:289 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[4][6] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC user */
	case 16: // STATE 1 - trash_bin.pml:248 - [(!(has_trash))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][1] = 1;
		if (!( !(((int)now.has_trash))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 17: // STATE 2 - trash_bin.pml:249 - [has_trash = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[3][2] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 18: // STATE 3 - trash_bin.pml:251 - [(has_trash)] (0:0:0 - 1)
		IfNotBlocked
		reached[3][3] = 1;
		if (!(((int)now.has_trash)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 19: // STATE 4 - trash_bin.pml:253 - [scan_card_user!user_id] (0:0:0 - 1)
		IfNotBlocked
		reached[3][4] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 20: // STATE 5 - trash_bin.pml:255 - [can_deposit_trash?user_id,1] (0:0:1 - 1)
		reached[3][5] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 21: // STATE 6 - trash_bin.pml:256 - [bin_changed?2,1] (0:0:0 - 1)
		reached[3][6] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 22: // STATE 7 - trash_bin.pml:258 - [change_bin!3,1] (0:0:0 - 1)
		IfNotBlocked
		reached[3][7] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 23: // STATE 8 - trash_bin.pml:259 - [bin_changed?3,1] (0:0:0 - 1)
		reached[3][8] = 1;
		if (q_zero(now.bin_changed))
		{	if (boq != now.bin_changed) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 24: // STATE 9 - trash_bin.pml:262 - [((bin_status.trash_in_outer_door==0))] (17:0:2 - 1)
		IfNotBlocked
		reached[3][9] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 25: // STATE 15 - trash_bin.pml:270 - [.(goto)] (0:17:0 - 2)
		IfNotBlocked
		reached[3][15] = 1;
		;
		_m = 3; goto P999; /* 0 */
	case 26: // STATE 12 - trash_bin.pml:266 - [((bin_status.trash_in_outer_door>0))] (0:0:0 - 1)
		IfNotBlocked
		reached[3][12] = 1;
		if (!((((int)now.bin_status.trash_in_outer_door)>0)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 27: // STATE 13 - trash_bin.pml:268 - [(1)] (17:0:0 - 1)
		IfNotBlocked
		reached[3][13] = 1;
		if (!(1))
			continue;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 28: // STATE 17 - trash_bin.pml:272 - [change_bin!3,2] (0:0:0 - 1)
		IfNotBlocked
		reached[3][17] = 1;
		if (q_full(now.change_bin))
			continue;
		...
		if (q_zero(now.change_bin)) { boq = now.change_bin; };
		_m = 2; goto P999; /* 0 */
	case 29: // STATE 18 - trash_bin.pml:273 - [bin_changed?3,1] (0:0:0 - 1)
		reached[3][18] = 1;
		if (q_zero(now.bin_changed))
		{	if (boq != now.bin_changed) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 30: // STATE 19 - trash_bin.pml:274 - [can_deposit_trash?user_id,0] (0:0:1 - 1)
		reached[3][19] = 1;
		if (q_zero(now.can_deposit_trash))
		{	if (boq != now.can_deposit_trash) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 31: // STATE 26 - trash_bin.pml:278 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[3][26] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC truck */
	case 32: // STATE 1 - trash_bin.pml:237 - [request_truck?bin_id] (0:0:2 - 1)
		reached[2][1] = 1;
		...
		XX=1;
		(trpt+1)->bup.ovals = grab_ints(2);
		(trpt+1)->bup.ovals[0] = ((int)((P2 *)_this)->bin_id);
		;
		...
		if (TstOnly) return 1; /* TT */
		/* dead 2: bin_id */  (trpt+1)->bup.ovals[1] = ((P2 *)_this)->bin_id;
#ifdef HAS_CODE
		if (!readtrail)
#endif
			((P2 *)_this)->bin_id = 0;
		_m = 4; goto P999; /* 0 */
	case 33: // STATE 6 - trash_bin.pml:240 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[2][6] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC server */
	case 34: // STATE 1 - trash_bin.pml:221 - [check_user?user_id] (0:0:1 - 1)
		reached[1][1] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 35: // STATE 2 - trash_bin.pml:224 - [((user_id!=42))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][2] = 1;
		if (!((((int)((P1 *)_this)->user_id)!=42)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 36: // STATE 3 - trash_bin.pml:225 - [user_valid!user_id,1] (0:0:0 - 1)
		IfNotBlocked
		reached[1][3] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 37: // STATE 4 - trash_bin.pml:226 - [((user_id==42))] (0:0:0 - 1)
		IfNotBlocked
		reached[1][4] = 1;
		if (!((((int)((P1 *)_this)->user_id)==42)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 38: // STATE 5 - trash_bin.pml:227 - [user_valid!user_id,0] (0:0:0 - 1)
		IfNotBlocked
		reached[1][5] = 1;
		if (q_full(now.user_valid))
			continue;
		...
		if (q_zero(now.user_valid)) { boq = now.user_valid; };
		_m = 2; goto P999; /* 0 */
	case 39: // STATE 11 - trash_bin.pml:230 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[1][11] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC bin */
	case 40: // STATE 1 - trash_bin.pml:106 - [change_bin?3,2] (0:0:0 - 1)
		reached[0][1] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 41: // STATE 2 - trash_bin.pml:108 - [((bin_status.out_door==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		if (!((now.bin_status.out_door==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 42: // STATE 3 - trash_bin.pml:109 - [bin_status.out_door = 2] (0:0:1 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 43: // STATE 4 - trash_bin.pml:110 - [bin_changed!3,1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][4] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 44: // STATE 5 - trash_bin.pml:111 - [user_closed_outer_door!1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][5] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 45: // STATE 8 - trash_bin.pml:113 - [change_bin?3,1] (0:0:0 - 1)
		reached[0][8] = 1;
		if (q_zero(now.change_bin))
		{	if (boq != now.change_bin) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 46: // STATE 9 - trash_bin.pml:115 - [(((bin_status.out_door==2)&&(bin_status.lock_out_door==1)))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][9] = 1;
		if (!(((now.bin_status.out_door==2)&&(now.bin_status.lock_out_door==1))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 47: // STATE 10 - trash_bin.pml:116 - [bin_status.out_door = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][10] = 1;
		(trpt+1)->bup.oval = now.bin_status.out_door;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 48: // STATE 11 - trash_bin.pml:117 - [bin_changed!3,1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][11] = 1;
		if (q_full(now.bin_changed))
			continue;
		...
		if (q_zero(now.bin_changed)) { boq = now.bin_changed; };
		_m = 2; goto P999; /* 0 */
	case 49: // STATE 14 - trash_bin.pml:119 - [change_bin?2,2] (0:0:0 - 1)
		reached[0][14] = 1;
		if (q_zero(now.change_bin))
		{	if (boq != now.change_bin) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 50: // STATE 15 - trash_bin.pml:121 - [(((bin_status.lock_out_door==1)&&(bin_status.out_door==2)))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][15] = 1;
		if (!(((now.bin_status.lock_out_door==1)&&(now.bin_status.out_door==2))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 51: // STATE 16 - trash_bin.pml:123 - [bin_status.lock_out_door = 2] (0:0:1 - 1)
		IfNotBlocked
		reached[0][16] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 52: // STATE 17 - trash_bin.pml:126 - [((((bin_status.trash_in_outer_door>0)&&(bin_status.trap_door==2))&&(bin_status.trash_on_trap_door==0)))] (28:0:2 - 1)
		IfNotBlocked
		reached[0][17] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 53: // STATE 26 - trash_bin.pml:138 - [.(goto)] (0:28:0 - 3)
		IfNotBlocked
		reached[0][26] = 1;
		;
		_m = 3; goto P999; /* 0 */
	case 54: // STATE 20 - trash_bin.pml:130 - [((((bin_status.trash_in_outer_door>0)&&(bin_status.trap_door==2))&&(bin_status.trash_on_trap_door>0)))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][20] = 1;
		if (!((((((int)now.bin_status.trash_in_outer_door)>0)&&(now.bin_status.trap_door==2))&&(((int)now.bin_status.trash_on_trap_door)>0))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 55: // STATE 21 - trash_bin.pml:132 - [(1)] (28:0:0 - 1)
		IfNotBlocked
		reached[0][21] = 1;
		if (!(1))
			continue;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 56: // STATE 22 - trash_bin.pml:133 - [(((bin_status.trash_in_outer_door>0)&&(bin_status.trap_door==1)))] (28:0:2 - 1)
		IfNotBlocked
		reached[0][22] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 57: // STATE 28 - trash_bin.pml:139 - [bin_changed!2,1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][28] = 1;
		if (q_full(now.bin_changed))
			continue;
		...
		if (q_zero(now.bin_changed)) { boq = now.bin_changed; };
		_m = 2; goto P999; /* 0 */
	case 58: // STATE 31 - trash_bin.pml:141 - [change_bin?2,1] (0:0:0 - 1)
		reached[0][31] = 1;
		if (q_zero(now.change_bin))
		{	if (boq != now.change_bin) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 59: // STATE 32 - trash_bin.pml:143 - [(((bin_status.lock_out_door==2)&&(bin_status.out_door==2)))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][32] = 1;
		if (!(((now.bin_status.lock_out_door==2)&&(now.bin_status.out_door==2))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 60: // STATE 33 - trash_bin.pml:144 - [bin_status.lock_out_door = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][33] = 1;
		(trpt+1)->bup.oval = now.bin_status.lock_out_door;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 61: // STATE 34 - trash_bin.pml:145 - [bin_changed!2,1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][34] = 1;
		if (q_full(now.bin_changed))
			continue;
		...
		if (q_zero(now.bin_changed)) { boq = now.bin_changed; };
		_m = 2; goto P999; /* 0 */
	case 62: // STATE 37 - trash_bin.pml:148 - [weigh_trash?1] (0:0:0 - 1)
		reached[0][37] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 63: // STATE 38 - trash_bin.pml:150 - [((bin_status.trap_door==2))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][38] = 1;
		if (!((now.bin_status.trap_door==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 64: // STATE 39 - trash_bin.pml:151 - [trash_weighted!bin_status.trash_on_trap_door] (0:0:0 - 1)
		IfNotBlocked
		reached[0][39] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 65: // STATE 42 - trash_bin.pml:153 - [change_bin?1,2] (0:0:0 - 1)
		reached[0][42] = 1;
		if (q_zero(now.change_bin))
		{	if (boq != now.change_bin) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 66: // STATE 43 - trash_bin.pml:155 - [(((bin_status.trap_door==1)&&(bin_status.ram==2)))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][43] = 1;
		if (!(((now.bin_status.trap_door==1)&&(now.bin_status.ram==2))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 67: // STATE 44 - trash_bin.pml:156 - [bin_status.trap_door = 2] (0:0:1 - 1)
		IfNotBlocked
		reached[0][44] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 68: // STATE 45 - trash_bin.pml:157 - [bin_changed!1,1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][45] = 1;
		if (q_full(now.bin_changed))
			continue;
		...
		if (q_zero(now.bin_changed)) { boq = now.bin_changed; };
		_m = 2; goto P999; /* 0 */
	case 69: // STATE 46 - trash_bin.pml:158 - [(((bin_status.trap_door==1)&&(bin_status.ram==1)))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][46] = 1;
		if (!(((now.bin_status.trap_door==1)&&(now.bin_status.ram==1))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 70: // STATE 47 - trash_bin.pml:159 - [bin_status.trap_destroyed = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][47] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 71: // STATE 48 - trash_bin.pml:160 - [bin_changed!1,0] (0:0:0 - 1)
		IfNotBlocked
		reached[0][48] = 1;
		if (q_full(now.bin_changed))
			continue;
		...
		if (q_zero(now.bin_changed)) { boq = now.bin_changed; };
		_m = 2; goto P999; /* 0 */
	case 72: // STATE 51 - trash_bin.pml:162 - [change_bin?1,1] (0:0:0 - 1)
		reached[0][51] = 1;
		if (q_zero(now.change_bin))
		{	if (boq != now.change_bin) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 73: // STATE 52 - trash_bin.pml:164 - [((bin_status.trap_door==2))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][52] = 1;
		if (!((now.bin_status.trap_door==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 74: // STATE 53 - trash_bin.pml:166 - [bin_status.trap_door = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][53] = 1;
		(trpt+1)->bup.oval = now.bin_status.trap_door;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 75: // STATE 54 - trash_bin.pml:169 - [((bin_status.trash_on_trap_door>0))] (62:0:2 - 1)
		IfNotBlocked
		reached[0][54] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 76: // STATE 60 - trash_bin.pml:175 - [.(goto)] (0:62:0 - 2)
		IfNotBlocked
		reached[0][60] = 1;
		;
		_m = 3; goto P999; /* 0 */
	case 77: // STATE 58 - trash_bin.pml:173 - [(1)] (62:0:0 - 1)
		IfNotBlocked
		reached[0][58] = 1;
		if (!(1))
			continue;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 78: // STATE 62 - trash_bin.pml:176 - [bin_changed!1,1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][62] = 1;
		if (q_full(now.bin_changed))
			continue;
		...
		if (q_zero(now.bin_changed)) { boq = now.bin_changed; };
		_m = 2; goto P999; /* 0 */
	case 79: // STATE 65 - trash_bin.pml:179 - [change_ram?1] (0:0:0 - 1)
		reached[0][65] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 80: // STATE 66 - trash_bin.pml:181 - [((bin_status.ram==2))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][66] = 1;
		if (!((now.bin_status.ram==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 81: // STATE 67 - trash_bin.pml:183 - [bin_status.ram = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[0][67] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 82: // STATE 68 - trash_bin.pml:185 - [((bin_status.trap_door==1))] (76:0:2 - 1)
		IfNotBlocked
		reached[0][68] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 83: // STATE 74 - trash_bin.pml:193 - [.(goto)] (0:76:0 - 2)
		IfNotBlocked
		reached[0][74] = 1;
		;
		_m = 3; goto P999; /* 0 */
	case 84: // STATE 71 - trash_bin.pml:189 - [((bin_status.trap_door==2))] (76:0:1 - 1)
		IfNotBlocked
		reached[0][71] = 1;
		if (!((now.bin_status.trap_door==2)))
			continue;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 85: // STATE 76 - trash_bin.pml:194 - [ram_changed!1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][76] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 86: // STATE 79 - trash_bin.pml:196 - [change_ram?2] (0:0:0 - 1)
		reached[0][79] = 1;
		if (q_zero(now.change_ram))
		{	if (boq != now.change_ram) continue;
		} else
		...
		_m = 4; goto P999; /* 0 */
	case 87: // STATE 80 - trash_bin.pml:198 - [((bin_status.ram==1))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][80] = 1;
		if (!((now.bin_status.ram==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 88: // STATE 81 - trash_bin.pml:199 - [bin_status.ram = 2] (0:0:1 - 1)
		IfNotBlocked
		reached[0][81] = 1;
		(trpt+1)->bup.oval = now.bin_status.ram;
		now.bin_status.ram = 2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 89: // STATE 82 - trash_bin.pml:200 - [ram_changed!1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][82] = 1;
		if (q_full(now.ram_changed))
			continue;
		...
		if (q_zero(now.ram_changed)) { boq = now.ram_changed; };
		_m = 2; goto P999; /* 0 */
	case 90: // STATE 85 - trash_bin.pml:203 - [empty_bin?1] (0:0:0 - 1)
		reached[0][85] = 1;
		...
		_m = 4; goto P999; /* 0 */
	case 91: // STATE 86 - trash_bin.pml:205 - [((((bin_status.out_door==2)&&(bin_status.lock_out_door==2))&&(bin_status.ram==2)))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][86] = 1;
		if (!((((now.bin_status.out_door==2)&&(now.bin_status.lock_out_door==2))&&(now.bin_status.ram==2))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 92: // STATE 87 - trash_bin.pml:207 - [bin_status.trash_compressed = 0] (0:90:2 - 1)
		IfNotBlocked
		reached[0][87] = 1;
		(trpt+1)->bup.ovals = grab_ints(2);
		(trpt+1)->bup.ovals[0] = ((int)now.bin_status.trash_compressed);
		...
		;
		_m = 3; goto P999; /* 1 */
	case 93: // STATE 90 - trash_bin.pml:210 - [bin_emptied!1] (0:0:0 - 1)
		IfNotBlocked
		reached[0][90] = 1;
		...
		_m = 2; goto P999; /* 0 */
	case 94: // STATE 96 - trash_bin.pml:213 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][96] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
