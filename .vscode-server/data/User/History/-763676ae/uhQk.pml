...
proctype bin(byte bin_id) {
    ...
    :: change_bin?OuterDoor, closed ->
        ...
        :: bin_status.out_door == open ->
            ...
            user_closed_outer_door!true;  // Notify main control that the door is closed
        fi
    ...
    :: change_bin?LockOuterDoor, closed ->
        ...
        :: bin_status.lock_out_door == open && bin_status.out_door == closed ->
            ...
            // Check if trash can fall to the trap door
            if
    ...
    // Handle trap door and ram operations
    :: weigh_trash?true ->
    ...
    // Move trash to trap door when appropriate
    :: bin_status.lock_out_door == closed && bin_status.trash_in_outer_door > 0 ->
        if
        :: bin_status.trap_door == closed && bin_status.trash_on_trap_door == 0 ->
